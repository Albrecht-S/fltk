...
if(FLTK_USE_BUNDLED_ZLIB)
  ...
  set(FLTK_ZLIB_LIBRARIES fltk::z)
  list(APPEND FLTK_IMAGE_LIBRARIES fltk::z)
else()
...
if(FLTK_USE_BUNDLED_PNG)
  ...
  # This is assumed to exist if PNG_FOUND is true and HAVE_PNG_H is false.

  check_include_file(png.h HAVE_PNG_H)
  mark_as_advanced(HAVE_PNG_H)

  #  Check special symbols (functions) in the system libpng

  set(CMAKE_REQUIRED_LIBRARIES ${FLTK_PNG_LIBRARIES})
