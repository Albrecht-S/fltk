...
automatically (it is excluded from the default target "ALL").
  ...
  - FLTK_BUILD_HTML_DOCUMENTATION:BOOL=ON     target: html
  - FLTK_BUILD_PDF_DOCUMENTATION:BOOL=ON      target: pdf
...
and the corresponding build options are ON.
  ...
  - FLTK_INSTALL_HTML_DOCUMENTATION:BOOL=OFF
  - FLTK_INSTALL_PDF_DOCUMENTATION:BOOL=OFF
