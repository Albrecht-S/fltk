//
// Fl_Scroll_New test program for the Fast Light Tool Kit (FLTK).
//
...
Fl_Menu_Item choices[] = {
  {"0", 0, type_cb, (void*)0},
  {"HORIZONTAL", 0, type_cb, (void*)Fl_Scroll_New::HORIZONTAL},
  {"VERTICAL", 0, type_cb, (void*)Fl_Scroll_New::VERTICAL},
  {"BOTH", 0, type_cb, (void*)Fl_Scroll_New::BOTH},
  {"HORIZONTAL_ALWAYS", 0, type_cb, (void*)Fl_Scroll_New::HORIZONTAL_ALWAYS},
  {"VERTICAL_ALWAYS", 0, type_cb, (void*)Fl_Scroll_New::VERTICAL_ALWAYS},
  {"BOTH_ALWAYS", 0, type_cb, (void*)Fl_Scroll_New::BOTH_ALWAYS},
  {0}
};

void align_cb(Fl_Widget*, void* v) {
  thescroll->scrollbar_v()->align((uchar)((fl_intptr_t)v));
  thescroll->redraw();
}
...
int main(int argc, char** argv) {
  ...
  auto scroll = new Fl_Scroll_New(0,0,5*75,300);

  printf("children of scroll = %d\n", scroll->children());
  ...
  /* auto drawing = */ new Drawing(0,8*25,5*75,5*75,0);
  scroll->end();
  ...
  // test/debug: delete the scroll widget to check for memory leaks
  delete scroll;
  scroll = thescroll = nullptr;
