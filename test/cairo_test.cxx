...
// option --enable-cairo or CMake FLTK_OPTION_CAIRO.
//
...
//    (configure --enable-cairoext or CMake FLTK_OPTION_CAIROEXT)
...
int main(int argc, char **argv) {
  ...
  fl_message(
    ...
    "or one of the CMake options FLTK_OPTION_CAIRO or FLTK_OPTION_CAIROEXT, respectively.");
  return 0;
}
